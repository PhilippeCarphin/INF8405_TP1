...
\subsection{Interface utilisateur}
	...
	Initialement, la barre de droite présente une liste des réseaux disponible.
	...
	\begin{figure}[h]
		\centering
		\includegraphics[height=\interfacefigheight]{./interface/select_marker.jpg}
		\caption{\parbox[t]{3in}{Cliquer sur un marqueur ou élément de la liste fait apparaître
	...
	\begin{figure}[h]
		\centering
		\includegraphics[height=\interfacefigheight]{./interface/show_favorites.jpg}
		\caption{\parbox[t]{3in}{Cliquer sur un marqueur ou élément de la liste fait apparaître
		les détails de celui-ci}}
		\label{fig_favorites}
	\end{figure}
